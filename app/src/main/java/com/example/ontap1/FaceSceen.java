...
public class FaceSceen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_sceen);
        ...
        btnvui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(FaceSceen.this,""+data,Toast.LENGTH_SHORT).show();
                data.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            Toast.makeText(FaceSceen.this,"You happy,keep going :D x"+data,Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                data1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            Toast.makeText(FaceSceen.this,"You great, look positive :D x"+data1,Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                data2.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            Toast.makeText(FaceSceen.this,"Don't worry, everything fine :D x"+data2,Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        btnfinish.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(FaceSceen.this,"Have a good day :D x",Toast.LENGTH_SHORT).show();
                FirebaseAuth.getInstance().signOut();
                startActivity(new Intent(FaceSceen.this, MainActivity.class));
